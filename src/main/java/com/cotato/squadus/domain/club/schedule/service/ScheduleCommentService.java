...
public class ScheduleCommentService {
	...
	public ScheduleCommentResponse addComment(Long scheduleId, ScheduleCommentRequest scheduleCommentRequest) {
		...
		ClubMember member = clubMemberRepository.findById(scheduleCommentRequest.getMemberId())
			.orElseThrow(
				() -> new EntityNotFoundException("Member not found with id: " + scheduleCommentRequest.getMemberId()));
	...
	@Transactional
	public ScheduleCommentResponse updateComment(Long scheduleId, Long commentId,
		ScheduleCommentRequest scheduleCommentRequest) {
