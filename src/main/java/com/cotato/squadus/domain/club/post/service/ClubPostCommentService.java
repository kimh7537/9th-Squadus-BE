...
public class ClubPostCommentService {
	...
	public List<ClubPostCommentResponse> findAllClubPostComments(Long postId) {
		List<ClubPostCommentResponse> clubPostCommentResponseList = clubPostCommentRepository.findAllByClubPost_PostId(
				postId).stream()
	...
	@Transactional
	public ClubPostCommentCreateResponse createClubPostComment(Long clubId, Long postId,
		ClubPostCommentCreateRequest clubPostCommentCreateRequest) {
