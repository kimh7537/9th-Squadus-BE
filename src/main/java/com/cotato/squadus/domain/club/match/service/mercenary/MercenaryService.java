...
public class MercenaryService {
	...
	public MercenaryCreateResponse createMatch(MercenaryCreateRequest mercenaryCreateRequest) {
		...
		if (!clubAdminMemberRepository.findActiveAdminByClubIdAndClubMemberId(homeClub.getClubId(),
			mercenaryCreateRequest.getClubMemberId()).isPresent()) {
	...
	public List<MercenaryCreateResponse> findAllMatches() {
		...
		return mercenaryPostRepository.findAll().stream()
			.filter(mercenaryPost -> {
				LocalDateTime matchDateTime = LocalDateTime.of(mercenaryPost.getMatchStartDate(),
	...
	@Transactional
	public MercenaryCreateResponse updateMercenaryPost(Long mercenaryPostId,
		MercenaryCreateRequest mercenaryCreateRequest) {
		...
		mercenaryPost.update(
			...
			new MatchPlace(mercenaryCreateRequest.getMatchPlace().getCity(),
				mercenaryCreateRequest.getMatchPlace().getDistrict()),
