...
import static com.cotato.squadus.domain.club.match.entity.mercenary.QMercenaryPost.mercenaryPost;
...
public class MercenaryPostRepositoryImpl implements MercenaryPostRepositoryCustom{
    ...
    @Override
    public List<MercenaryPost> customFindMatchesByFilter(SportsCategory sportsCategory, String city, String district, ClubTier clubTier, Boolean placeProvided) {
    ...
    private BooleanExpression sportsCategoryEq(SportsCategory sportsCategory) {
        return sportsCategory != null ? mercenaryPost.homeClub.sportsCategory.stringValue().eq(sportsCategory.name()) : null;
    }
