...
import com.cotato.squadus.api.post.dto.ClubPostCreateResponse;
import com.cotato.squadus.api.post.dto.ClubPostLikesResponse;
...
public class ClubPostController {
	...
	public ResponseEntity<ClubPostSummaryListResponse> getAllClubPostsSummaryByClubId(@PathVariable Long clubId) {
		//        clubMemberService.validateClubMember(clubId);
		ClubPostSummaryListResponse allClubPostsSummaryByClubId = clubPostService.findAllClubPostsSummaryByClubId(
			clubId);
	...
	public ResponseEntity<ClubPostLikesResponse> increaseClubPostLikes(@PathVariable Long clubId,
