...
public class MatchResultController {
	...
	public ResponseEntity<MatchDetailWithWinResponse> getMatchDetailWithWin(@PathVariable Long matchPostId) {
		...
		MatchDetailWithWinResponse response = new MatchDetailWithWinResponse(matchDetailResponse,
	...
	public ResponseEntity<MatchResultResponse> addMatchResult(@PathVariable Long matchPostId,
	...
	public ResponseEntity<MatchFinalResultResponse> getFinalMatchResult(@PathVariable Long matchPostId,
